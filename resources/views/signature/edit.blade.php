...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item active">Edit Signature</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('signature.update', ['id' => $signature->id]) }}" method="post"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="receiver" id="receiver" class="form-control" required="required"
                                value="{{ $signature->receiver }}">
                        </div>

                        <div class="form-group">
                            <label for="description">Subject</label>
                            <textarea name="subject" id="subject" rows="3" class="form-control" required="required">{{ $signature->subject }}</textarea>
                        </div>

                        <div class="form-group">
                            <label for="name">Designation</label>
                            <input type="text" name="designation" id="designation" class="form-control"
                                required="required" value="{{ $signature->designation }}">
                        </div>

                        <div class="form-group">
                            <label for="image">Document</label>
                            <input type="file" accept=".pdf, .docx, .doc, .odt" class="form-control p-1"
                                name="document">
                            Current document: 
